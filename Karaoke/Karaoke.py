...
import sqlite3
from urllib.parse import urlparse, parse_qs
karaoke = Blueprint("karaoke", __name__ ,static_folder="../static", template_folder="../templates")
...
@karaoke.route('/add_song', methods=['GET', 'POST'])
def add_song():
...
@karaoke.route('/songs/<int:song_id>', methods=['GET'])
